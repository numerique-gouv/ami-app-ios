...
//  AMI-xcodegen
//
//  Created by Nicolas Buquet on 17/09/2026.
...
struct InfoPanelView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Données reçues")
...
#Preview {
    InfoPanelView(content: InfoPanelContent(text:
        """
...
struct InfoPanelContent: Identifiable {
    let id = UUID()
    let text: String
}
